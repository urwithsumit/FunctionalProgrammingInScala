...
/**
  * This is a mix of examples to scalaprogramming the fold function implementations.
  *
  */
object ScalaFeaturesApp extends App {
  ...
  def searchByFileCriteria(query: String, matcher: (String, String) => Boolean) = {
    def getFiles = (new File("/Sumit/LeetCodes/src/main/scala/com/scalaprogramming/leetcode").listFiles())
