 ...
 * Modify the result of problem P10 in such a way that if an element has no duplicates it is simply copied into the result ls. Only elements with duplicates are transferred as (N, E) terms.
 * Example:
 *
